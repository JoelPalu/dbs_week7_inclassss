...
public class Main {
    public static void main(String[] args) {
        ...
        // Add sample students
        Student student1 = new Student("John Doe", "john@example.com", Akido_tiers_ENUM.WHITE, LocalDate.now());
        Student student2 = new Student("Jane Smith", "jane@example.com", Akido_tiers_ENUM.BLACK, LocalDate.now());
        ...
        student1.setRank(Akido_tiers_ENUM.BLACK);
